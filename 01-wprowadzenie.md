...
| **Rodzaje Anomaly Detection** | 1. **One-class SVM** – uczy się granic normalnych danych, identyfikuje obserwacje poza nimi <br> 2. **Isolation Forest** – losowe podziały; anomalie łatwiejsze do izolacji <br> 3. **Autoencoder** – sieć neuronowa ucząca się rekonstrukcji; wysoki błąd = anomalia <br> 4. **Statistical Methods (Z-score, IQR)** – progi statystyczne wykrywające outlierów <br> 5. **Azure Anomaly Detector** – gotowa usługa do wykrywania anomalii w szeregach czasowych |
